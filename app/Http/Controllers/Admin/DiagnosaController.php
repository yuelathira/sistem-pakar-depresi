...
class DiagnosaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.diagnosa', compact('diagnosas'));
    }
    ...
    {
        return view('admin.tambah', ["name" => "Diagnosa"]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.diagnosa.index')
            ->with('success', 'Diagnosa created successfully.');
    }
    ...
    {
        return view('admin.edit-diagnosa', compact('diagnosa'));
    }
    ...
    public function update(Request $request, Diagnosa $diagnosa)
    {
        ...
        return redirect()->route('admin.diagnosa.index')
            ->with('success', 'Diagnosa updated successfully');
    }
    /**
